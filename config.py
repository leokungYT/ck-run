...
SCREENCAP_SCALE = 1.0
# เว้นระยะจับภาพขั้นต่ำต่อจอ (วินาที) — ต่ำ = เจอปุบจับปับ (เร็วสุด)
#   0.033 = ~30fps ไม่หน่วง  |  ถ้า adb แน่น/หน่วง ค่อยเพิ่ม (เช่น 0.1-0.3)
...
CHECK_FIX_RUN = 1         # หา fix-run.bmp ตลอดช่วง play8-11 เจอแล้ว reset เริ่มจาก play8 ใหม่
